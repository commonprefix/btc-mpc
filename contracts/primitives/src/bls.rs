            ...
            vss_pk: vec![
                G2Element {
                    bytes: vec![
                        ...
                        223, 205, 132, 13, 129, 63, 173, 210, 187, 3, 251, 85, 122, 159, 242, 24,
                        66, 141, 69, 49, 123, 7, 90, 192, 172, 217, 189, 107, 108, 111, 194, 173,
                        14, 74, 241, 156, 184, 228, 165, 248, 71, 163, 0, 212, 62, 95, 110, 185,
                ...
                G2Element {
                    bytes: vec![
                        ...
                        128, 20, 21, 180, 119, 157, 85, 234, 224, 38, 209, 38, 120, 200, 29, 3, 57,
                        182, 177, 189, 239, 193, 34, 136, 146, 227, 64, 189, 37, 7, 181, 111, 21,
                        243, 251, 173, 207, 132, 9, 209, 112, 52, 234, 241, 229, 73, 170, 9, 105,
                ...
                G2Element {
                    bytes: vec![
                        ...
                        187, 210, 94, 55, 10, 18, 101, 105, 21, 169, 11, 8, 65, 185, 28, 6, 105,
                        52, 40, 202, 216, 107, 173, 229, 26, 149, 84, 92, 197, 2, 174, 209, 73, 40,
                        174, 249, 8, 145, 171, 1, 164, 224, 115, 90, 154, 179, 167, 135, 64, 239,
                        155, 202, 176, 245, 117, 84, 3, 210, 101, 139, 248, 14, 243,
                    ],
                },
            ],
            encrypted_shares: MultiRecipientEncryption {
                r_g: G2Element {
                    bytes: vec![
                        ...
                        137, 205, 129, 200, 2, 234, 252, 81, 155, 238, 255, 217, 18, 187, 3, 14,
                        110, 206, 90, 110, 185, 177, 86, 30, 183, 203, 210, 200, 127, 202, 122,
                        174, 207, 152, 172, 150, 127, 142, 18, 57, 6, 221, 149, 111, 227, 236, 77,
                        69, 73, 107, 153, 81, 9, 224, 158, 150, 36, 84, 66, 210, 148, 196, 119,
                    ],
                },
                encs: vec![
                    vec![
                ...
                nizk: DLNizk {
                    A: G2Element {
                        bytes: vec![
                            ...
                            48, 122, 110, 120, 3, 155, 153, 17, 55, 151, 186, 84, 6, 53, 242, 91,
                            242, 16, 208, 60, 127, 62, 123, 133, 29, 23, 222, 69, 38, 86, 140, 47,
                            240, 49, 114, 41, 152, 233, 185, 127, 32, 33, 73, 111, 234, 130, 77,
                            236, 239, 133, 202, 17, 187, 194, 114, 179, 21, 86, 170, 118, 242, 51,
                            100, 196, 110,
                        ],
                    },
                    z: Scalar {
                        bytes: vec![
                            97, 217, 142, 161, 138, 150, 21, 127, 9, 87, 240, 141, 23, 25, 228,
                            181, 52, 200, 121, 188, 43, 26, 178, 91, 46, 120, 41, 156, 171, 58,
                            174, 46,
                        ],
                    },
                },
                ...
                proof: RecoveryPackage {
                    ephemeral_key: G2Element {
                        bytes: vec![
                            ...
                            186, 78, 208, 55, 143, 161, 190, 190, 60, 3, 41, 89, 171, 206, 18, 90,
                            230, 115, 15, 212, 187, 219, 49, 209, 8, 77, 23, 189, 54, 240, 220, 82,
                            13, 28, 129, 23, 186, 17, 59, 225, 110, 229, 208, 197, 10, 62, 218,
                            196, 93, 242, 84, 125, 39, 159, 110, 98, 229, 36, 9, 170, 77, 188, 55,
                            245, 35, 30,
                        ],
                    },
                    proof: DdhTupleNizk {
                        A: G2Element {
                            bytes: vec![
                                ...
                                195, 67, 200, 57, 118, 49, 7, 96, 169, 130, 113, 206, 99, 159, 19,
                                245, 67, 116, 12, 20, 56, 41, 202, 181, 203, 1, 191, 119, 17, 87,
                                0, 106, 128, 177, 114, 78, 105, 124, 171, 76, 35, 102, 251, 104,
                                68, 57, 75, 34, 35, 39, 103, 97, 207, 206, 250, 208, 36, 114, 168,
                        ...
                        B: G2Element {
                            bytes: vec![
                                ...
                                23, 71, 110, 144, 221, 102, 53, 79, 252, 41, 35, 183, 155, 79, 220,
                                190, 83, 25, 9, 102, 108, 134, 81, 189, 178, 246, 217, 20, 225,
                                189, 40, 43, 43, 112, 85, 49, 216, 220, 172, 194, 52, 201, 251,
                                105, 135, 192, 183, 95, 220, 226, 204, 230, 1, 254, 4, 158, 196,
                                196, 192, 165, 109, 82, 51, 64, 30, 12,
                            ],
                        },
                        z: Scalar {
                            bytes: vec![
                    ...
                    Node {
                        ...
                        pk: G2Element {
                            bytes: vec![
                                ...
                                60, 64, 254, 146, 238, 129, 176, 117, 217, 176, 110, 70, 70, 156,
                                211, 13, 112, 80, 184, 23, 93, 171, 31, 210, 132, 32, 185, 240, 66,
                                135, 179, 118, 148, 39, 199, 254, 255, 140, 238, 76, 9, 10, 230,
                                151, 164, 28, 69, 57, 12, 136, 49, 205, 104, 180, 36, 101, 89, 36,
                                168, 94, 72, 3, 175, 16, 108, 40, 218,
                            ],
                        },
                        weight: 2,
                    },
                    Node {
                        ...
                        pk: G2Element {
                            bytes: vec![
                                ...
                                179, 85, 176, 47, 225, 190, 81, 169, 157, 141, 13, 22, 143, 141,
                                43, 12, 237, 7, 162, 7, 110, 199, 129, 218, 2, 101, 74, 137, 117,
                                48, 98, 79, 215, 180, 8, 225, 214, 47, 23, 117, 163, 19, 20, 252,
                                85, 61, 185, 174, 85, 196, 227, 230, 142, 13, 86, 45, 92, 215, 79,
                                59, 208, 5, 188, 7, 15, 64, 39,
                            ],
                        },
                        weight: 3,
                    },
                    Node {
                        ...
                        pk: G2Element {
                            bytes: vec![
                                ...
                                145, 189, 53, 246, 206, 203, 228, 49, 179, 0, 153, 44, 150, 127,
                                121, 251, 125, 22, 113, 8, 49, 35, 110, 185, 196, 109, 171, 85,
                                159, 58, 109, 237, 69, 44, 80, 54, 250, 206, 205, 73, 77, 241, 10,
                                8, 90, 43, 247, 47, 45, 110, 4, 187, 48, 38, 113, 224, 30, 217,
                                144, 114, 149, 33, 95, 160, 176, 130, 52,
                            ],
                        },
                        weight: 0,
                    },
